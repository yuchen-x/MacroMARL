...
from macro_marl.cores.value_based.mac_cen_q.team_cen_condi import Team_RNN
from macro_marl.cores.value_based.mac_cen_q.utils.memory_cen_condi import ReplayMemory_rand, ReplayMemory_epi
from macro_marl.cores.value_based.mac_cen_q.utils.utils import save_check_point
from macro_marl.cores.value_based.mac_cen_q.learning_methods_cen_condi import QLearn_squ_cen_condi_0

QLearns = [QLearn_squ_cen_condi_0]

class MacCenQ(object):
    ...
    def __init__(self,
        ...
        # create team
        self.team = Team_RNN(env, env_terminate_step, n_env, memory, env.n_agent, QLearns[cen_mode], h_stable_at,
    ...
    def learn(self):
        ...
        while self.team.episode_count < self.total_epi:
            ...
            if (not step % self.train_freq) and self.team.episode_count >= self.start_train:
                ...
                # update epsilon
                if self.db_step:
                    self.team.update_epsilon(self.step)
                else:
