...
from macro_marl.cores.value_based.mac_dec_ddrqn.team import Team_RNN
from macro_marl.cores.value_based.mac_dec_ddrqn.utils.memory import ReplayMemory_rand, ReplayMemory_epi
from macro_marl.cores.value_based.mac_dec_ddrqn.utils.utils import save_check_point
from macro_marl.cores.value_based.mac_dec_ddrqn.learning_methods import QLearn_squ_dec_cen_0

QLearn_squ_dec_cen = [QLearn_squ_dec_cen_0]

class MacDecDDRQN(object):
    ...
    def __init__(self,
        ...
        # create team
        self.team = Team_RNN(env, env_terminate_step, n_env, memory, env.n_agent, QLearn_squ_dec_cen[l_mode], h_stable_at,
