...
from macro_marl.MA_dec_cen_hddrqn.team import Team_RNN
from macro_marl.MA_dec_cen_hddrqn.utils.memory import ReplayMemory_rand, ReplayMemory_epi
from macro_marl.MA_dec_cen_hddrqn.utils.utils import save_check_point
from macro_marl.MA_dec_cen_hddrqn.learning_methods import QLearn_squ_dec_cen_0, QLearn_squ_dec_cen_1
...
def train(env_id, obs_one_hot, target_flick_prob, agent_trans_noise, target_rand_move, 
          ...
          eval_freq, run_id, run_time, resume, save_ckpt, save_ckpt_time, seed, save_dir, device, **kwargs):
    ...
    # create team
    team = Team_RNN(env, env_terminate_step, n_env, memory, env.n_agent, QLearn_squ_dec_cen[l_mode], h_stable_at,
    ...
    while team.episode_count < total_epi:
        ...
        if (time.time()-t) // 3600 >= save_ckpt_time and save_ckpt:
            save_check_point(team.envs_runner, team.agents, team.cen_controller, step, team.episode_count, team.hysteretic, team.epsilon, save_dir, team.memory, run_id, team.TEST_PERFORM) 
            save_ckpt_time *= 2
