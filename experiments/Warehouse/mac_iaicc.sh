...
for ((i=0; i<20; i++))
do
    ma_iaicc_rnn_V.py --save_dir='ma_iaicc_warehouse_A' \
                    --run_id=$i \
                    --env_id='OSD-D-v7' \
                    --n_agent=3 \
                    --l_mode=1 \
...
for ((i=0; i<20; i++))
do
    ma_iaicc_rnn_V.py --save_dir='ma_iaicc_warehouse_B' \
                    --run_id=$i \
                    --env_id='OSD-T-v1' \
                    --n_agent=4 \
                    --l_mode=1 \
...
for ((i=0; i<20; i++))
do
    ma_iaicc_rnn_V.py --save_dir='ma_iaicc_warehouse_C' \
                    --run_id=$i \
                    --env_id='OSD-T-v1' \
                    --n_agent=4 \
                    --l_mode=1 \
...
for ((i=0; i<20; i++))
do
    ma_iaicc_rnn_V.py --save_dir='ma_iaicc_warehouse_E' \
                    --run_id=$i \
                    --env_id='OSD-D-v7' \
                    --n_agent=3 \
                    --l_mode=1 \
...
for ((i=0; i<20; i++))
do
    ma_iaicc_rnn_V.py --save_dir='ma_iaicc_warehouse_A_ablation' \
                    --run_id=$i \
                    --env_id='OSD-D-v7' \
                    --n_agent=3 \
                    --l_mode=1 \
